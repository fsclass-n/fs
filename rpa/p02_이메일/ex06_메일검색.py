...
with MailBox("imap.gmail.com", 993) as mailbox:
    ...
    # for msg in mailbox.fetch('(TEXT "test mail")', reverse=True):
    #     print("[{}] {}".format(msg.from_, msg.subject))
    ...
    # 2026년 5월 3일 이후의 메일 가져오기
    # 03-MAY-2026 -> 2026년 5월 3일
    # for msg in mailbox.fetch('(SENTSINCE 03-MAY-2026)', reverse=True):
    #     print("[{}] {}".format(msg.from_, msg.subject))

    # 2026년 5월 1일에 온 메일 가져오기
    # for msg in mailbox.fetch('(ON 01-MAY-2026)', reverse=True, limit=3):
    #     print("[{}] {}".format(msg.from_, msg.subject))

    # 두 가지 이상의 조건을 모두 만족하는(그리고) 메일 가져오기
    # for msg in mailbox.fetch('(ON 04-MAY-2026 SUBJECT "test")', reverse=True):
    #     print("[{}] {}".format(msg.from_, msg.subject))
